...
class PredictPipeline:
    ...
    def predict(self, features):
        try:
            ...
            model_path='C:\\Users\\Hp\\Organic-Super-Store-Prediction-using-ML\\artifacts\\model.pkl'
            #preprocessor_path = os.path.join("..","..",'artifacts', 'preprocessor.pkl')  
            preprocessor_path='C:\\Users\\Hp\\Organic-Super-Store-Prediction-using-ML\\artifacts\\preprocessor.pkl'
